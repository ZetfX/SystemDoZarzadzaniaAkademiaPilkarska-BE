...
import edu.uni.lodz.system.akademia.pilkarska.application.services.SignupService;
...
public class AuthController {
    ...
    public ResponseEntity<?> register(@Valid @RequestBody SignUpRequest signUpRequest) {
        return ResponseEntity.ok(signupService.registerAcademyAdmin(signUpRequest));
    }
